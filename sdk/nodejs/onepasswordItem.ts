...
export class OnepasswordItem extends pulumi.CustomResource {
     ...
     */
    public static get(name: string, id: pulumi.Input<pulumi.ID>, state?: OnepasswordItemState, opts?: pulumi.CustomResourceOptions): OnepasswordItem {
        return new OnepasswordItem(name, <any>state, { ...opts, id: id });
    }

    /** @internal */
    public static readonly __pulumiType = 'onepassword:index/onepasswordItem:OnepasswordItem';
     ...
     * Password for this item.
     */
    public readonly passwordRecipe!: pulumi.Output<outputs.OnepasswordItemPasswordRecipe | undefined>;
    /**
     ...
     */
    public readonly sections!: pulumi.Output<outputs.OnepasswordItemSection[] | undefined>;
    /**
    ...
    constructor(name: string, argsOrState?: OnepasswordItemArgs | OnepasswordItemState, opts?: pulumi.CustomResourceOptions) {
        let resourceInputs: pulumi.Inputs = {};
        opts = opts || {};
        if (opts.id) {
            const state = argsOrState as OnepasswordItemState | undefined;
            ...
            const args = argsOrState as OnepasswordItemArgs | undefined;
 ...
 */
export interface OnepasswordItemState {
    /**
     * The category of the item. One of ["login" "password" "database"]
     */
     ...
     * Password for this item.
     */
    passwordRecipe?: pulumi.Input<inputs.OnepasswordItemPasswordRecipe>;
    /**
     * (Only applies to the database category) The port the database is listening on.
     */
     ...
     * A list of custom sections in an item
     */
    sections?: pulumi.Input<pulumi.Input<inputs.OnepasswordItemSection>[]>;
    /**
     * An array of strings of the tags assigned to the item.
     */
