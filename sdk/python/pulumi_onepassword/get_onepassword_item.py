...
__all__ = [
    'GetOnepasswordItemResult',
    'AwaitableGetOnepasswordItemResult',
    'get_onepassword_item',
    'get_onepassword_item_output',
]

@pulumi.output_type
class GetOnepasswordItemResult:
    """
    ...
    @property
    @pulumi.getter
    def sections(self) -> Sequence['outputs.GetOnepasswordItemSectionResult']:
        """
...
class AwaitableGetOnepasswordItemResult(GetOnepasswordItemResult):
    # pylint: disable=using-constant-test
    def __await__(self):
        if False:
            yield self
        return GetOnepasswordItemResult(
...
def get_onepassword_item(note_value: Optional[str] = None,
                         title: Optional[str] = None,
                         uuid: Optional[str] = None,
                         vault: Optional[str] = None,
                         opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOnepasswordItemResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('onepassword:index/getOnepasswordItem:getOnepasswordItem', __args__, opts=opts, typ=GetOnepasswordItemResult).value

    return AwaitableGetOnepasswordItemResult(
...
@_utilities.lift_output_func(get_onepassword_item)
def get_onepassword_item_output(note_value: Optional[pulumi.Input[Optional[str]]] = None,
                                title: Optional[pulumi.Input[Optional[str]]] = None,
                                uuid: Optional[pulumi.Input[Optional[str]]] = None,
                                vault: Optional[pulumi.Input[str]] = None,
                                opts: Optional[pulumi.InvokeOptions] = None) -> pulumi.Output[GetOnepasswordItemResult]:
    """
    Use this data source to get details of an item by its vault uuid and either the title or the uuid of the item.
