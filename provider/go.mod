module github.com/FullTag/pulumi-onepassword/provider
...
require (
	github.com/1Password/terraform-provider-onepassword v1.2.0
...
require (
	...
	github.com/1Password/connect-sdk-go v1.5.1 // indirect
